...
"""autogenerated by genpy from rsl/LeapFrame.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','uint32','geometry_msgs/Vector3[]','float64','geometry_msgs/Vector3','time','rsl/LeapGesture[]','rsl/LeapHand[]','rsl/LeapPointable[]']
