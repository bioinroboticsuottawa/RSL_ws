// Generated by gencpp from file my_leapmotion/LeapFrame.msg
// DO NOT EDIT!


#ifndef MY_LEAPMOTION_MESSAGE_LEAPFRAME_H
#define MY_LEAPMOTION_MESSAGE_LEAPFRAME_H
...
#include <geometry_msgs/Vector3.h>
#include <my_leapmotion/LeapGesture.h>
#include <my_leapmotion/LeapHand.h>
#include <my_leapmotion/LeapPointable.h>
...
struct LeapFrame_
{
  ...
  _timestamp_type timestamp;
   ...
   typedef std::vector< ::my_leapmotion::LeapGesture_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::my_leapmotion::LeapGesture_<ContainerAllocator> >::other >  _gestures_type;
  _gestures_type gestures;

   typedef std::vector< ::my_leapmotion::LeapHand_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::my_leapmotion::LeapHand_<ContainerAllocator> >::other >  _hands_type;
  _hands_type hands;

   typedef std::vector< ::my_leapmotion::LeapPointable_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::my_leapmotion::LeapPointable_<ContainerAllocator> >::other >  _pointables_type;
  _pointables_type pointables;




  typedef boost::shared_ptr< ::my_leapmotion::LeapFrame_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::my_leapmotion::LeapFrame_<ContainerAllocator> const> ConstPtr;

}; // struct LeapFrame_

typedef ::my_leapmotion::LeapFrame_<std::allocator<void> > LeapFrame;

typedef boost::shared_ptr< ::my_leapmotion::LeapFrame > LeapFramePtr;
typedef boost::shared_ptr< ::my_leapmotion::LeapFrame const> LeapFrameConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::my_leapmotion::LeapFrame_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::my_leapmotion::LeapFrame_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::my_leapmotion::LeapFrame_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_leapmotion::LeapFrame_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_leapmotion::LeapFrame_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
{
  ...
  static const char* value(const ::my_leapmotion::LeapFrame_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1be96930b5a5f7daULL;
  static const uint64_t static_value2 = 0x0ae5f4ae85fd4442ULL;
};

template<class ContainerAllocator>
struct DataType< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
{
  static const char* value()
  {
    return "my_leapmotion/LeapFrame";
  }
...
template<class ContainerAllocator>
struct Definition< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::my_leapmotion::LeapFrame_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::my_leapmotion::LeapFrame_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.gestures.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::my_leapmotion::LeapGesture_<ContainerAllocator> >::stream(s, indent + "    ", v.gestures[i]);
    }
    ...
    for (size_t i = 0; i < v.hands.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::my_leapmotion::LeapHand_<ContainerAllocator> >::stream(s, indent + "    ", v.hands[i]);
    }
    ...
    for (size_t i = 0; i < v.pointables.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::my_leapmotion::LeapPointable_<ContainerAllocator> >::stream(s, indent + "    ", v.pointables[i]);
    }
  }
};
...
#endif // MY_LEAPMOTION_MESSAGE_LEAPFRAME_H
