// Generated by gencpp from file my_leapmotion/LeapHand.msg
// DO NOT EDIT!


#ifndef MY_LEAPMOTION_MESSAGE_LEAPHAND_H
#define MY_LEAPMOTION_MESSAGE_LEAPHAND_H
...
struct LeapHand_
{
  ...
  typedef boost::shared_ptr< ::my_leapmotion::LeapHand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::my_leapmotion::LeapHand_<ContainerAllocator> const> ConstPtr;

}; // struct LeapHand_

typedef ::my_leapmotion::LeapHand_<std::allocator<void> > LeapHand;

typedef boost::shared_ptr< ::my_leapmotion::LeapHand > LeapHandPtr;
typedef boost::shared_ptr< ::my_leapmotion::LeapHand const> LeapHandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::my_leapmotion::LeapHand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::my_leapmotion::LeapHand_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::my_leapmotion::LeapHand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::my_leapmotion::LeapHand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_leapmotion::LeapHand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_leapmotion::LeapHand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_leapmotion::LeapHand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_leapmotion::LeapHand_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::my_leapmotion::LeapHand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::my_leapmotion::LeapHand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe1f168193e08481cULL;
  static const uint64_t static_value2 = 0x556346f6b4c70f16ULL;
};

template<class ContainerAllocator>
struct DataType< ::my_leapmotion::LeapHand_<ContainerAllocator> >
{
  static const char* value()
  {
    return "my_leapmotion/LeapHand";
  }
...
template<class ContainerAllocator>
struct Definition< ::my_leapmotion::LeapHand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::my_leapmotion::LeapHand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::my_leapmotion::LeapHand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::my_leapmotion::LeapHand_<ContainerAllocator>& v)
  {
...
#endif // MY_LEAPMOTION_MESSAGE_LEAPHAND_H
