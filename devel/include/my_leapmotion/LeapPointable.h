// Generated by gencpp from file my_leapmotion/LeapPointable.msg
// DO NOT EDIT!


#ifndef MY_LEAPMOTION_MESSAGE_LEAPPOINTABLE_H
#define MY_LEAPMOTION_MESSAGE_LEAPPOINTABLE_H
...
struct LeapPointable_
{
  ...
  typedef boost::shared_ptr< ::my_leapmotion::LeapPointable_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::my_leapmotion::LeapPointable_<ContainerAllocator> const> ConstPtr;

}; // struct LeapPointable_

typedef ::my_leapmotion::LeapPointable_<std::allocator<void> > LeapPointable;

typedef boost::shared_ptr< ::my_leapmotion::LeapPointable > LeapPointablePtr;
typedef boost::shared_ptr< ::my_leapmotion::LeapPointable const> LeapPointableConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::my_leapmotion::LeapPointable_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::my_leapmotion::LeapPointable_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::my_leapmotion::LeapPointable_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_leapmotion::LeapPointable_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_leapmotion::LeapPointable_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
{
  ...
  static const char* value(const ::my_leapmotion::LeapPointable_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x17349b2abd8a7a1fULL;
  static const uint64_t static_value2 = 0x31586b0c52c91cb7ULL;
};

template<class ContainerAllocator>
struct DataType< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
{
  static const char* value()
  {
    return "my_leapmotion/LeapPointable";
  }
...
template<class ContainerAllocator>
struct Definition< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::my_leapmotion::LeapPointable_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::my_leapmotion::LeapPointable_<ContainerAllocator>& v)
  {
...
#endif // MY_LEAPMOTION_MESSAGE_LEAPPOINTABLE_H
