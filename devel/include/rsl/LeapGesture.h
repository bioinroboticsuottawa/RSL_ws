// Generated by gencpp from file rsl/LeapGesture.msg
// DO NOT EDIT!


#ifndef RSL_MESSAGE_LEAPGESTURE_H
#define RSL_MESSAGE_LEAPGESTURE_H
...
struct LeapGesture_
{
  ...
  typedef boost::shared_ptr< ::rsl::LeapGesture_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rsl::LeapGesture_<ContainerAllocator> const> ConstPtr;

}; // struct LeapGesture_

typedef ::rsl::LeapGesture_<std::allocator<void> > LeapGesture;

typedef boost::shared_ptr< ::rsl::LeapGesture > LeapGesturePtr;
typedef boost::shared_ptr< ::rsl::LeapGesture const> LeapGestureConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rsl::LeapGesture_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rsl::LeapGesture_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rsl::LeapGesture_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rsl::LeapGesture_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rsl::LeapGesture_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rsl::LeapGesture_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rsl::LeapGesture_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rsl::LeapGesture_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rsl::LeapGesture_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rsl::LeapGesture_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x967e671f82992095ULL;
  static const uint64_t static_value2 = 0xab401d46b1c41311ULL;
};

template<class ContainerAllocator>
struct DataType< ::rsl::LeapGesture_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rsl/LeapGesture";
  }
...
template<class ContainerAllocator>
struct Definition< ::rsl::LeapGesture_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rsl::LeapGesture_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rsl::LeapGesture_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rsl::LeapGesture_<ContainerAllocator>& v)
  {
    s << indent << "center: ";
    s << std::endl;
...
#endif // RSL_MESSAGE_LEAPGESTURE_H
