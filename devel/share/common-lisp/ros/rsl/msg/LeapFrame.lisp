...
(cl:defclass <LeapFrame> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (gestures
    :reader gestures
    :initarg :gestures
    :type (cl:vector rsl-msg:LeapGesture)
   :initform (cl:make-array 0 :element-type 'rsl-msg:LeapGesture :initial-element (cl:make-instance 'rsl-msg:LeapGesture)))
   (hands
    :reader hands
    :initarg :hands
    :type (cl:vector rsl-msg:LeapHand)
   :initform (cl:make-array 0 :element-type 'rsl-msg:LeapHand :initial-element (cl:make-instance 'rsl-msg:LeapHand)))
   (pointables
    :reader pointables
    :initarg :pointables
    :type (cl:vector rsl-msg:LeapPointable)
   :initform (cl:make-array 0 :element-type 'rsl-msg:LeapPointable :initial-element (cl:make-instance 'rsl-msg:LeapPointable))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LeapFrame>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LeapFrame)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rsl-msg:<LeapFrame> is deprecated: use rsl-msg:LeapFrame instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsl-msg:header-val is deprecated.  Use rsl-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'currentFrameRate-val :lambda-list '(m))
(cl:defmethod currentFrameRate-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsl-msg:currentFrameRate-val is deprecated.  Use rsl-msg:currentFrameRate instead.")
  (currentFrameRate m))
...
(cl:defmethod timestamp-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsl-msg:timestamp-val is deprecated.  Use rsl-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'gestures-val :lambda-list '(m))
(cl:defmethod gestures-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsl-msg:gestures-val is deprecated.  Use rsl-msg:gestures instead.")
  (gestures m))

(cl:ensure-generic-function 'hands-val :lambda-list '(m))
(cl:defmethod hands-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsl-msg:hands-val is deprecated.  Use rsl-msg:hands instead.")
  (hands m))

(cl:ensure-generic-function 'pointables-val :lambda-list '(m))
(cl:defmethod pointables-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsl-msg:pointables-val is deprecated.  Use rsl-msg:pointables instead.")
  (pointables m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LeapFrame>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'gestures)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rsl-msg:LeapGesture))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'hands)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rsl-msg:LeapHand))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'pointables)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rsl-msg:LeapPointable))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
